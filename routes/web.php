...
Route::middleware('throttle:limit-check')->group(function (){
    ...
    Route::prefix('/smartlab')->group(function () {
        Route::get('/', function () {
    ...
    Route::prefix('admin/roki')->middleware('admin')->group(function () {
...
//        Route::get('/payment-confirmation', [UserController::class, 'recharge_confirm_submit'])->name('payment_confirmation');
        ...
        Route::post('external-deposit', [UserController::class, 'apiPayment'])->name('deposit.payment');
        //Ledger
        ...
        Route::get('/receive-income', [UserController::class, 'received_amount'])->name('receive.income');
        ...
        Route::get('access-payment/{amount}/{method}/{number}/{url}/{oid}/{user}', [UserController::class, 'payment_index'])->name('payment');


        Route::post('onepay/request', [OnepayController::class, 'onepay']);
...
// CronJob endpoints were public and could be triggered externally (used for automatic distribution).
// To make profit distribution manual only, these public endpoints are disabled below.
// If you previously used an external cron to hit these routes, remove that cron or update it
// to call the admin UI manually instead.
// Route::get('commission-interest', [AdminController::class, 'commission']);
// Route::get('checkin-commission', [AdminController::class, 'checkin_commission']);
