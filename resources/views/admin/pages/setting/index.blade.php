                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mt-2">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label for="withdraw_notes">minimum_deposit</label>
                                                <input type="number" step="0.01" min="0" class="form-control is-valid"
                                                       name="minimum_deposit" id="minimum_deposit"
                                                       placeholder="minimum_deposit "
                                                       value="{{$data ? $data->minimum_deposit : old('minimum_deposit')}}">
